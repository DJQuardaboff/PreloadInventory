...
public class PreloadInventoryDatabase {
    ...
    public class ScannedItemTable {
        ...
        public static final String TABLE_CREATION = NAME + " ( " + ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " + LOCATION_ID + " INTEGER, " + PRELOAD_ITEM_ID + " INTEGER, " + DATE_TIME + " BIGINT )";
    ...
    public class ScannedLocationTable {
        ...
        public static final String TABLE_CREATION = NAME + " ( " + ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " + PRELOAD_LOCATION_ID + " INTEGER, " + DATE_TIME + " BIGINT )";
